    ...
    <main className="w-full flex flex-col items-center px-[10px] pb-[40px]">
      ...
      <div className="w-full max-w-[1180px] flex flex-wrap gap-[10px] justify-center mt-[18px]">
        {Array.from({ length: 6 }).map((_, idx) => (
          <div key={idx} className="bg-card rounded-card p-[15px] w-full max-w-[382px] min-w-[335px]">
            <div className="flex gap-[10px] items-center">
              ...
              <div className="flex flex-col gap-[8px] w-full">
                ...
                <div className="flex gap-[5px] pt-[4px]">
                  <div className="ehvm-skeleton h-[27px] w-[95px] rounded-pill" />
                  <div className="ehvm-skeleton h-[27px] w-[110px] rounded-pill" />
